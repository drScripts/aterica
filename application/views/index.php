    ...
    <div class="container idiw">
        ...
        <div class="row justify-content-center my-5">
            ...
            <div class="col-lg-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5 animate__animated animate__zoomInRight">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 mb-4 wadwa animate__animated animate__backInUp"
                                            style="color:white">Masukan Data Diri
                                            Anda</h1>
                                    </div>
                                    <form class="user" method="post" action="<?= base_url('Profile/check') ?>">
                                        <div class="animate__animated animate__rotateInDownRight form-group">
                                        ...
                                        <div class="animate__animated animate__rotateInDownLeft form-group">
                                        ...
                                        <div class="form-group animate__animated animate__rotateInDownRight">
                                        ...
                                        <div class="form-group animate__animated animate__rotateInDownLeft">
                                        ...
                                        <div class="mb-5 form-group animate__animated animate__rotateInDownLeft">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5 mx-auto">
                                                ...
                                                <button type="submit"
                                                    class="mt-5 animate__animated animate__rotateInDownRight btn btn-primary btn-user btn-block">
                                                    Proses!
                                                </button>
                                            </div>
                                        </div>
